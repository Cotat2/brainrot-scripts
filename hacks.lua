...
local antiKnockbackEnabled = false -- Nueva variable para Anti-Knockback
...
-- FUNCIÓN CORREGIDA: Anti-Knockback
local function toggleAntiKnockback(state)
 ...
    
    if state then
        antiKnockbackConnection = humanoid.StateChanged:Connect(function(oldState, newState)
            if newState == Enum.HumanoidStateType.GettingUp or newState == Enum.HumanoidStateType.Ragdoll then
...
local function createMenu()
 ...
    antiKnockbackButton.Size = UDim2.new(0, 180, 0, 40)
    antiKnockbackButton.Position = UDim2.new(0, 20, 0, 140)
    antiKnockbackButton.Text = "Anti-Knockback: OFF"
    antiKnockbackButton.BackgroundColor3 = Color3.new(0.4, 0.4, 0.4)
    antiKnockbackButton.Parent = stealerTab
    antiKnockbackButton.MouseButton1Click:Connect(function()
        toggleAntiKnockback(not antiKnockbackEnabled)
